...
3) Access the `workbench` named `test-codegen-matrix-nov6-notebook`
...
5) In the terminal, run `cd test-codegen-matrix-nov6` to navigate to your sample app's directory
